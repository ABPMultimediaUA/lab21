...
examples/window/CMakeFiles/window.dir/Window.cpp.obj: examples/window/Window.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=C:\SFML\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/window/CMakeFiles/window.dir/Window.cpp.obj"
	cd /d C:\SFML\examples\window && C:\MinGW\bin\g++.exe  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles\window.dir\Window.cpp.obj -c C:\SFML\examples\window\Window.cpp
...
examples/window/CMakeFiles/window.dir/Window.cpp.i: cmake_force
	...
	cd /d C:\SFML\examples\window && C:\MinGW\bin\g++.exe $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E C:\SFML\examples\window\Window.cpp > CMakeFiles\window.dir\Window.cpp.i
...
examples/window/CMakeFiles/window.dir/Window.cpp.s: cmake_force
	...
	cd /d C:\SFML\examples\window && C:\MinGW\bin\g++.exe $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S C:\SFML\examples\window\Window.cpp -o CMakeFiles\window.dir\Window.cpp.s
...
examples/window/window.exe: examples/window/CMakeFiles/window.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=C:\SFML\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable window.exe"
	cd /d C:\SFML\examples\window && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\window.dir\link.txt --verbose=$(VERBOSE)
...
examples/window/CMakeFiles/window.dir/clean:
	cd /d C:\SFML\examples\window && $(CMAKE_COMMAND) -P CMakeFiles\window.dir\cmake_clean.cmake
.PHONY : examples/window/CMakeFiles/window.dir/clean

examples/window/CMakeFiles/window.dir/depend:
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" C:\SFML C:\SFML\examples\window C:\SFML C:\SFML\examples\window C:\SFML\examples\window\CMakeFiles\window.dir\DependInfo.cmake --color=$(COLOR)
