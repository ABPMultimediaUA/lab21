...
#define U_MVP                   "u_MVP"
#define U_LIGHT_POSITION        "u_LightPosition"
#define U_LIGHT_AMBIENT         "u_LightAmbient"
#define U_LIGHT_DIFFUSE         "u_LightDiffuse"
#define U_LIGHT_SPECULAR        "u_LightSpecular"
