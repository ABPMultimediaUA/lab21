...
namespace dwn
{
    class NetGame
    {
        public:
            ...
            void sendBroadcast(unsigned int messageID, unsigned int objectID, TMsgEnemy datosEnemy);/*dwe::vec3f position,
        ...
        private:
            ...
            static const unsigned int       _time_search_server = 2500;   // Milisegundos de espera buscando servidores
